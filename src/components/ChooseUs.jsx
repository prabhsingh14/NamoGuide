...
const WhyUsCard = ({ icon, heading, description }) => {
    return (
        <div className='flex flex-col justify-center items-center text-center h-full bg-white p-4 shadow-md rounded-lg'>
            <div className="text-4xl text-[#FF6F00] mb-4">{icon}</div> 
...
const ChooseUs = () => {
    return (
        <div className='flex flex-col items-center mt-[100px]'>
            <RxQuestionMarkCircled className='text-[#FF6F00] text-[60px]'/>
            <h2 className='text-[#1976D2] text-[40px] font-bold'>Why choose us?</h2>
